...
- [ ] PHP lints on 5.6 (`php -l` across `index.php`, `luna/luna.php`, `luna/luna.classes`, `luna/luna.mods`)
...
- [ ] No new bundled dependencies / no PHP 7+ "modernisation" (see CONTRIBUTING.md)
