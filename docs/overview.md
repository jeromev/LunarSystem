...
archival revival carries the version forward to **0.8.44-alpha**.
...
| **the `luna:` namespace** | The custom RDF ontology, `https://jeromev.github.io/LunarSystem/ontology#`, used for system predicates (`nid`, `lid`, `content`, `level`, …). |
